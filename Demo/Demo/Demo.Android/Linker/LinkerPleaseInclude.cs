...
namespace Demo.Android.Linker
{
    ...
    public class LinkerPleaseInclude
    {
        ...
        {
            sb.ProgressChanged += (sender, args)
        ...
        public void Include(MvxDefaultTemplateSelector defaultTemplateSelector)
        {
            defaultTemplateSelector = new MvxDefaultTemplateSelector();
        }
